...
// проходжу по масиву images методом map
const galleryMarcup = images
  ...
  .join("");
//Додаю розмітку методом insertAdjacentHTML()
galleryContainer.insertAdjacentHTML("beforeend", galleryMarcup);
//на галерею вішаю слухач подій (делегування)
galleryContainer.addEventListener("click", handeClick);
